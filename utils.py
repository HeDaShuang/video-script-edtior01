...
#创建模型实列
    model = ChatOpenAI(openai_api_key="sk-z65dHrAmRvNSxh9NC690770e1060419bB396C1A94fCfD629", max_tokens=1000,temperature=creativity, base_url="https://api.aigc369.com/v1")
